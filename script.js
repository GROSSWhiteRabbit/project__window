...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2020-10-06');
...
function changeModalState(modalState) {
  var sizeInputs = document.querySelectorAll('.popup_calc_content .form-control'),
  ...
  checkBoxs.forEach(function (checkBox, i) {
    checkBox.addEventListener('input', function () {
      checkBoxs.forEach(function (Box, k) {
        if (i != k) {
  ...
  formsWindow.forEach(function (form, i) {
...
var forms = function forms(modalState) {
  function bindForm(form) {
    ...
    form.user_phone.addEventListener('input', function () {
    ...
    form.addEventListener('submit', function (e) {
      ...
      postDate( // 'http://localhost:3000/POST',
      'assets/server.php', JSON.stringify(Object.fromEntries(data.entries()))).then(function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              if (!response.ok) {
                console.error("POST Erorr url:".concat(url, "  status:").concat(response.status));
              }
...
function images() {
  ...
  parentImages.addEventListener('click', function (e) {
    e.preventDefault();

    if (e.target && e.target.classList.contains('preview')) {
      img.setAttribute('src', e.target.parentNode.getAttribute('href'));
      Object(_modal__WEBPACK_IMPORTED_MODULE_0__["showModal"])(popup);
    }
  });
  popup.addEventListener('click', function (e) {
    if (e.target && e.target == popup) {
      Object(_modal__WEBPACK_IMPORTED_MODULE_0__["closeModal"])(popup);
    }
  });
}
...
var modals = function modals() {
  function bindModal(selectorModal, selectorTriggers, selecttorClose) {
    ...
    var requiredInputSeklector = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  ...
  bindModal('.popup', '.phone_link', '.popup .popup_close'); // popup_calc  Modal
...
var tabs = function tabs() {
  function bindTab(btnsSelector, btnsParentSelector, constentSelector, activeClass, inline) {
    ...
    function showTabByBtn(btn) {
      var namberTab;
      tabBtns.forEach(function (item, n) {
        if (btn == tabBtns[n]) {
          namberTab = n;
        }
...
function timer(deadline) {
  function calcTimeLeft(deadline) {
    var timeLeft = Date.parse(deadline) - Date.now();
    return {
      time: timeLeft,
      days: Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["addZero"])((timeLeft / 1000 / 60 / 60 / 24).toFixed()),
      hours: Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["addZero"])((timeLeft / 1000 / 60 / 60 % 24).toFixed()),
      minutes: Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["addZero"])((timeLeft / 1000 / 60 % 60).toFixed()),
      seconds: Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["addZero"])((timeLeft / 1000 % 60).toFixed())
    };
  }
